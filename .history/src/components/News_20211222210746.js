...
const News = (props)=>{
    ...
    const updateNews = async ()=> {
        ...
        const url = `https://newsapi.org/v2/top-headlines?q="CNN"&country=${props.country}&category=${props.category}&apiKey=${props.apiKey}&page=${page}&pageSize=${props.pageSize}`; 
        setLoading(true)
